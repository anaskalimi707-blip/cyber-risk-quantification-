...
class ReportGenerateRequest(BaseModel):
    title: str = Field(..., example="Q3 2026 Executive Cyber Risk & Investment Optimization Report")
    report_type: str = Field(default="Executive", example="Executive")  # Executive, CISO, Investment, Compliance, Vendor, Incident
